                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_lastname" type="number" name="zip" class="form-control" value="<?php echo $zip?>">
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_middlename" type="number" name="pnumber" class="form-control" value="<?php echo $phone?>" required="required">
