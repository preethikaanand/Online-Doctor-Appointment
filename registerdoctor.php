    ...
    <html>
    <head>
        <title>Register Doctor Page</title>
        <meta charset="UTF-8">
    ...
    <body>
         ...
         <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-18 offset-xl-2 py-5">
                    ...
                    <form id="contact-form" method="post" action="registerdoctorcheck.php" role="form" enctype="multipart/form-data">
            ...
            <div class="col-md-6" style="visibility: hidden;">
                                    <div class="form-group">
                                        ...
                                        <input id="form_id" type="number" name="cid" class="form-control" >
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_lastname" type="text" name="add1" class="form-control" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_lastname" type="text" name="add2" class="form-control" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_lastname" type="text" name="state" class="form-control" >
            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="form_middlename">Experience :</label>
                            <input id="form_middlename" type="text" name="exp" class="form-control"  >
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="spc" class="form-control" >
                 </div>   
            </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="form_name">Attach Image :</label>
