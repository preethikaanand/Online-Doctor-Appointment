...
$insert_contact = "INSERT INTO customer(fn,ln,gender,dob,add_line_one,add_line_two,city,state,email,password,zip,phone) VALUES ('$fname','$lname','$gen', '$date', '$address1','$address2','$city','$state','$mail','$hashed_password','$zip','$phone')";
