            ...
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_middlename" type="text" name="pnumber" class="form-control" value="<?php echo $phone?>">
        ...
        <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_middlename" type="text" name="grave" class="form-control" value="<?php echo $grave?>">
