        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-18 offset-xl-2 py-5">
                    ...
                    <form id="contact-form" method="post" action="update_doctor.php" role="form">
        ...
        <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="form_middlename" type="number" name="pnumber" class="form-control" value="<?php echo $grave?>" >
