...
<body>
	...
	<div class="container-fluid">
		<form method="GET" action="homepage.php">
			...
			<input type ="hidden" name="page" value="<? echo 1 ?>"/>
		   	<div class="form-group">
		   		<div class= "col-sm-2">
	...
	echo "<table class='table table-striped table-hover' id='results'><tr><td>Doctor Name</td><td>Hospital Name</td><td>Specialty</td><td>Experience</td><td>Availablity</td></tr>";
	while($row=mysqli_fetch_array($result, MYSQLI_ASSOC))
		{
        	...
        	echo "<tr><td>".$dName."</td><td>".$hName."</td><td>".$specialty."</td><td>".$exp."</td><td>".$availabilty."</td><td><a href='login.html'>Book Appointment</a></td></tr>";
...
<ul class="pagination">
        <li class="<?php if($page <= 1){ echo 'disabled'; } ?>">
            <a href="homepage.php?location=<? echo $location; ?>&search=<? echo $keyword; ?>&category=<? echo $category; if($page <= 1){ echo '&page=1';} else { echo '&page='.($page - 1); } ?>">Prev</a>
        </li>
        <li class="<?php if($page >= $totalpages){ echo 'disabled'; } ?>">
            <a href="homepage.php?location=<? echo $location; ?>&search=<? echo $keyword; ?>&category=<? echo $category; if($page >= $totalpages){ echo '&page='.$totalpages;} else { echo '&page='.($page + 1); } ?>">Next</a>
        </li>
    </ul>
